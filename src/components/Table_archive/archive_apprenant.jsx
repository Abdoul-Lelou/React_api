...
export default function ArchiveApprenant() {
  ...
  const getArchive=()=>{
    ...
    return fetch("http://localhost:8000/api/user", {
      ...
      .then((res) => {
            if(res)
            setarchive(res.filter(x=> x.role === 'apprenant' && x.is_archive))     
      })
      .catch((error) => {
          console.log(error)
      });
          ...
          
          {
            ...
            searchField ?(
              ...
              dataSearch && dataSearch.map((data,index)=>{
                ...
                if(data.last_name.toUpperCase() === searchField.toUpperCase() || data.first_name.toUpperCase() === searchField.toUpperCase())
                {
                      return(
                ...
                <Input
                    ...
                    startAdornment={
                      ...
                      <InputAdornment position="start">
                        <IconButton onClick={()=>{setSearchField(searchField); filterSearch()} }>
